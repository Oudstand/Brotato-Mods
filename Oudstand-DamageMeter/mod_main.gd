...
func _register_mod_options() -> void:
	...
	mod_options.register_mod_options("DamageMeter", {
		...
		"options": [
			...
			{
				"type": "toggle",
				"id": "show_wave_summary",
				"label": "DAMAGEMETER_SHOW_WAVE_SUMMARY_LABEL",
				"default": true
			},
			{
				"type": "toggle",
				"id": "auto_open_wave_summary",
				"label": "DAMAGEMETER_AUTO_OPEN_WAVE_SUMMARY_LABEL",
				"default": false
			}
		],
...
func _setup_autoloads(mod_dir_path: String) -> void:
	...
	var data_tracker := _create_autoload(
		mod_dir_path.plus_file("extensions/data_tracker.gd"),
		"DamageMeterData"
	)
...
func _install_extensions(mod_dir_path: String) -> void:
	...
	ModLoaderMod.install_script_extension(extensions_dir.plus_file("base_shop_extension.gd"))
